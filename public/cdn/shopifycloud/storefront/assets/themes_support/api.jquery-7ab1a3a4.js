(() => {
    ...
    var require_api_jquery = __commonJS({
        "javascripts/entrypoints/themes_support/api.jquery.js" (exports, module) {
            ...
            Shopify.pollForCartShippingRatesForDestination = function(shippingAddress, callback, errback) {
                ...
                var poller = function() {
                    jQuery.ajax("/cart/async_shipping_rates", {
                        dataType: "json",
                        success: function(response, textStatus2, xhr) {
                            if (xhr.status === 200) {
                                if (typeof callback == "function") {
            ...
            Shopify.getProduct = function(handle, callback) {
                jQuery.getJSON("/products/" + handle + ".js", function(product, textStatus2) {
                    if (typeof callback === "function") {
                        callback(product)
                    } else {
            ...
            Shopify.updateCartAttributes = function(attributes, callback) {
                ...
                if (jQuery.isArray(attributes)) {
                    jQuery.each(attributes, function(indexInArray, valueOfElement) {
                        ...
                        if (key !== "") {
                            data2 += "attributes[" + key + "]=" + attributeToString(valueOfElement.value) + "&"
                        }
                    })
                } else if (typeof attributes === "object" && attributes !== null) {
                    jQuery.each(attributes, function(key, value) {
                        data2 += "attributes[" + attributeToString(key) + "]=" + attributeToString(value) + "&"
                    })
                }
                var params = {
                    type: "POST",
